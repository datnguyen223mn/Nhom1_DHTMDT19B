...
ALTER TABLE GIAOVIEN ADD MaKhoa CHAR(10), CONSTRAINT FK_GIAOVIEN_KHOA FOREIGN KEY (MaKhoa) REFERENCES KHOA(MaKhoa)
GO
...
-- Thêm cột và liên kết khóa ngoại tham chiếu từ bảng LOP đến cột MaKhoa của bảng KHOA
ALTER TABLE LOP ADD MaKhoa CHAR(10)
...
-- 7. Thông tin LOP
INSERT INTO LOP (MaLop, TenLop, SiSo, MaGV_ChuNhiem, MaKhoa) VALUES
('L01', N'Lớp CNTT 1', 45, 'GV06', 'K01'),
('L02', N'Lớp Kinh tế 1', 40, 'GV07', 'K02'),
('L03', N'Lớp Ngoại ngữ 1', 38, 'GV08', 'K03'),
('L04', N'Lớp Kỹ thuật 1', 35, 'GV09', 'K04'),
('L05', N'Lớp Sư phạm 1', 42, 'GV10', 'K05')
GO

-- 8. Thông tin SINHVIEN
INSERT INTO SINHVIEN (MaSV, HoTen, NgaySinh, GioiTinh, DiaChi, SDT, MaLop) VALUES 
('SV01', N'Nguyễn Văn A', '2003-01-01', N'Nam', N'TP.HCM', '0981111111', 'L01'),
('SV02', N'Trần Thị B', '2003-02-02', N'Nữ', N'Hà Nội', '0982222222', 'L02'),
('SV03', N'Lê Văn C', '2003-03-03', N'Nam', N'Đà Nẵng', '0983333333', 'L03'),
('SV04', N'Phạm Thị D', '2003-04-04', N'Nữ', N'Huế', '0984444444', 'L04'),
('SV05', N'Đỗ Văn E', '2003-05-05', N'Nam', N'Cần Thơ', '0985555555', 'L05')
GO
...
-- Câu 12: Tìm mã và tên các khoa có số lượng sinh viên lớn hơn 50 người.
